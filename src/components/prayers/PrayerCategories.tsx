...
const PrayerCategoriesSection = () => {
    ...
    const displayCategories = useMemo(() => {
        if (!categories || !Array.isArray(categories)) return ['All Prayers'];

        // Filter out invalid categories and capitalize
        const validCategories = categories
            .filter(cat => cat && cat !== "2") // Remove empty or invalid entries
            .map(cat => {
        ...
        return ['All Prayers', ...validCategories];
    }, [categories]);
